...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}}]:} \PY{c}{\PYZsh{} define tf\PYZhy{}idf functions}
       \PY{k}{def} \PY{n+nf}{tf}\PY{p}{(}\PY{n}{word}\PY{p}{,} \PY{n}{blob}\PY{p}{)}\PY{p}{:}
           \PY{k}{return} \PY{n}{blob}\PY{o}{.}\PY{n}{words}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{n}{word}\PY{p}{)} \PY{o}{/} \PY{n+nb}{len}\PY{p}{(}\PY{n}{blob}\PY{o}{.}\PY{n}{words}\PY{p}{)}
       
       \PY{k}{def} \PY{n+nf}{n\PYZus{}containing}\PY{p}{(}\PY{n}{word}\PY{p}{,} \PY{n}{bloblist}\PY{p}{)}\PY{p}{:}
           \PY{k}{return} \PY{n+nb}{sum}\PY{p}{(}\PY{l+m+mi}{1} \PY{k}{for} \PY{n}{blob} \PY{o+ow}{in} \PY{n}{bloblist} \PY{k}{if} \PY{n}{word} \PY{o+ow}{in} \PY{n}{blob}\PY{p}{)}
       
       \PY{k}{def} \PY{n+nf}{idf}\PY{p}{(}\PY{n}{word}\PY{p}{,} \PY{n}{bloblist}\PY{p}{)}\PY{p}{:}
           \PY{k}{return} \PY{n}{math}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{bloblist}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{l+m+mi}{1} \PY{o}{+} \PY{n}{n\PYZus{}containing}\PY{p}{(}\PY{n}{word}\PY{p}{,} \PY{n}{bloblist}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}}]:} \PY{c}{\PYZsh{} Compute tf\PYZhy{}idf for ingredient field}
       
       \PY{c}{\PYZsh{} Ingredients corpus}
       \PY{n}{bloblist\PYZus{}ing} \PY{o}{=} \PY{p}{[}\PY{n}{tb}\PY{p}{(}\PY{n}{normalize\PYZus{}data}\PY{p}{(}\PY{n}{toString}\PY{p}{(}\PY{n}{ing}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{k}{for} \PY{n}{ing} \PY{o+ow}{in} \PY{p}{(}\PY{n}{Products\PYZus{}GS}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{ingredients}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)} \PY{o}{+} \PY{n}{Products\PYZus{}GS\PYZus{}tc}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{ingredients}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{]}
       
       \PY{c}{\PYZsh{} Compute TfIdf for ingredients, select the 10 most important words}
       \PY{n}{words\PYZus{}tfidf} \PY{o}{=} \PY{p}{[}\PY{p}{]}
       \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{blob} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{bloblist\PYZus{}ing}\PY{p}{)}\PY{p}{:}
           \PY{c}{\PYZsh{}print(\PYZdq{}Top words in document \PYZob{}\PYZcb{}\PYZdq{}.format(i + 1))}
           \PY{n}{scores} \PY{o}{=} \PY{p}{\PYZob{}}\PY{n}{word}\PY{p}{:} \PY{n}{tfidf}\PY{p}{(}\PY{p}{(}\PY{n}{word}\PY{p}{)}\PY{p}{,} \PY{n}{blob}\PY{p}{,} \PY{n}{bloblist\PYZus{}ing}\PY{p}{)} \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{blob}\PY{o}{.}\PY{n}{words}\PY{p}{\PYZcb{}}
           \PY{n}{sorted\PYZus{}words} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{scores}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{reverse}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
           \PY{n}{words} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}
           \PY{k}{for} \PY{n}{word}\PY{p}{,} \PY{n}{score} \PY{o+ow}{in} \PY{n}{sorted\PYZus{}words}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}\PY{p}{:}
               \PY{c}{\PYZsh{}print(\PYZdq{}\PYZbs{}tWord: \PYZob{}\PYZcb{}, TF\PYZhy{}IDF: \PYZob{}\PYZcb{}\PYZdq{}.format(word, round(score, 5)))}
               \PY{n}{words} \PY{o}{+}\PY{o}{=} \PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{ }\PY{l+s}{\PYZsq{}} \PY{o}{+} \PY{n}{word}\PY{p}{)}
           \PY{n}{words\PYZus{}tfidf}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{words}\PY{p}{)}
\end{Verbatim}
