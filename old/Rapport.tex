...
product\_name - brand - quantity (eg 6 for 6x33cL) - weight/volume (eg
33 for 6x33cL) - weight/volume\_total (eg 200 for 6x33cL) - unit (eg cL)
- description - ingredients - preservation - nutritional details -
origin - price - price per unit
...
structure of the html code. For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}}]:} \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n+nb}{id}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{produit}\PY{l+s}{\PYZdq{}} \PY{n}{style}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{position: relative; z\PYZhy{}index: 10;}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
           \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n+nb}{id}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{photoProduit}\PY{l+s}{\PYZdq{}} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{photoProduitNonCatalogue}\PY{l+s}{\PYZdq{}} \PY{n}{style}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{position: relative; z\PYZhy{}index:10}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
               \PY{o}{\PYZlt{}}\PY{n}{table} \PY{n}{cellspacing}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{0}\PY{l+s}{\PYZdq{}} \PY{n}{cellpadding}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{0}\PY{l+s}{\PYZdq{}} \PY{n}{width}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{100}\PY{l+s}{\PYZpc{}}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{tr} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{trImage}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                       \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{aligncenter}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                                       \PY{o}{\PYZlt{}}\PY{n}{img} \PY{n}{src}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{http://media.simplymarket.fr/PHOTO2/3104544/016354.jpg}\PY{l+s}{\PYZdq{}} \PY{n}{height}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{319px}\PY{l+s}{\PYZdq{}} \PY{n}{alt}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Achats FOIE GRAS DE CANARD ENTIER SUD OUEST GASTRONOMIQUE MONTFORT 300G \PYZhy{} FOIE GRAS \PYZhy{} Cybermarché \PYZhy{} Simply Market Livraison}\PY{l+s}{\PYZdq{}} \PY{n}{style}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{width: 319px; height: 319px;}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tr}\PY{o}{\PYZgt{}}
               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{table}\PY{o}{\PYZgt{}}
           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
       
                   \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{etiquette}\PY{l+s}{\PYZdq{}} \PY{n}{style}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{position :absolute; z\PYZhy{}index: 20;}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{n}{table}\PY{o}{\PYZgt{}}
                                       \PY{o}{\PYZlt{}}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{tr}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{prix}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                               \PY{o}{\PYZlt{}}\PY{n}{strong}\PY{o}{\PYZgt{}}
                                                                   \PY{l+m+mi}{29}\PY{p}{,}\PY{l+m+mi}{90}\PY{o}{\PYZam{}}\PY{n}{nbsp}\PY{p}{;}\PY{err}{€}
                                                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{strong}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                       \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tr}\PY{o}{\PYZgt{}}
                                       \PY{o}{\PYZlt{}}\PY{n}{tr}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{prixUnitaire}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                               \PY{o}{\PYZlt{}}\PY{n}{strong}\PY{o}{\PYZgt{}}\PY{l+m+mi}{99}\PY{p}{,}\PY{l+m+mi}{67}\PY{o}{\PYZam{}}\PY{n}{nbsp}\PY{p}{;}\PY{err}{€}\PY{o}{/}\PY{n}{Kg}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{strong}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                       \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tr}\PY{o}{\PYZgt{}}
                                       \PY{o}{\PYZlt{}}\PY{n}{tr}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{n}{td}\PY{o}{\PYZgt{}}
                                                                                                                                                                       \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{offre texteLotEuro}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                                           
                                       \PY{n}{Sur} \PY{n}{ce} \PY{n}{produit} \PY{p}{:}
                                       \PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}
                                                                           \PY{o}{\PYZlt{}}\PY{n}{strong}\PY{o}{\PYZgt{}}\PY{n}{Economisez} \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{strong}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{span}\PY{o}{\PYZgt{}}\PY{l+m+mi}{14}\PY{p}{,}\PY{l+m+mi}{95}\PY{o}{\PYZam{}}\PY{n}{nbsp}\PY{p}{;}\PY{err}{€}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{span}\PY{o}{\PYZgt{}}
           ...
           \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{redactionnel}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
               ...
               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
                   ...
                   \PY{l+m+mi}{99}\PY{p}{,}\PY{l+m+mi}{67}\PY{o}{\PYZam{}}\PY{n}{nbsp}\PY{p}{;}\PY{err}{€}\PY{o}{/}\PY{n}{Kg}
               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
               ...
               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
                       ...
                       \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{texteProduit}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{n}{label}\PY{o}{\PYZgt{}}\PY{n}{Valeurs} \PY{err}{é}\PY{n}{nerg}\PY{err}{é}\PY{n}{tiques}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{label}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{n}{div}\PY{o}{\PYZgt{}}\PY{n}{Valeurs} \PY{n}{moyennes} \PY{n}{pour} \PY{l+m+mi}{100}\PY{n}{g} \PY{p}{:} \PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}\PY{n}{Energie}\PY{p}{:} \PY{l+m+mi}{2101}\PY{n}{kJ} \PY{o}{\PYZhy{}} \PY{l+m+mi}{510}\PY{n}{kcal}\PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}\PY{n}{Mati}\PY{err}{è}\PY{n}{res} \PY{n}{grasses}\PY{p}{:} \PY{l+m+mi}{52}\PY{n}{g}\PY{p}{;} \PY{n}{Dont} \PY{n}{acides} \PY{n}{gras} \PY{n}{satur}\PY{err}{é}\PY{n}{s}\PY{p}{:} \PY{l+m+mi}{20}\PY{p}{,}\PY{l+m+mi}{2}\PY{n}{g}\PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}\PY{n}{Glucides}\PY{p}{:} \PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{6}\PY{n}{g}\PY{p}{;} \PY{n}{Dont} \PY{n}{sucres}\PY{p}{:} \PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{5}\PY{n}{g}\PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}\PY{n}{Fibres} \PY{n}{alimentaires}\PY{p}{:} \PY{l+m+mi}{0}\PY{n}{g}\PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}\PY{n}{Prot}\PY{err}{é}\PY{n}{ines}\PY{p}{:} \PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{0}\PY{n}{g}\PY{o}{\PYZlt{}}\PY{n}{br}\PY{o}{\PYZgt{}}\PY{n}{Sel}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{13}\PY{n}{g}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
               
               
                   \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
       
           \PY{o}{\PYZlt{}}\PY{n}{form} \PY{n}{method}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{get}\PY{l+s}{\PYZdq{}} \PY{n}{action}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{produit.php}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
               \PY{o}{\PYZlt{}}\PY{n}{table}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{tr} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{trFooter}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                       \PY{o}{\PYZlt{}}\PY{n}{td}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{n}{table} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{footer}\PY{l+s}{\PYZdq{}} \PY{n}{cellspacing}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{0}\PY{l+s}{\PYZdq{}} \PY{n}{cellpadding}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{0}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                               \PY{o}{\PYZlt{}}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{tr}\PY{o}{\PYZgt{}}
                                                                   \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{quantite}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{n}{table} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{qtePicto}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                               \PY{o}{\PYZlt{}}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{tr}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{td}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{a} \PY{n}{href}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{javascript:addP(}\PY{l+s}{\PYZsq{}}\PY{l+s}{PRO\PYZus{}QUANTITE\PYZus{}217751}\PY{l+s}{\PYZsq{}}\PY{l+s}{, \PYZhy{}1)}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{img} \PY{n}{src}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{http://www.livraison.simplymarket.fr/images\PYZus{}27/pictoMoins3.png}\PY{l+s}{\PYZdq{}} \PY{n}{alt}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Moins}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{a}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{style}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{background\PYZhy{}color: \PYZsh{}FFFFFF;}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                       \PY{o}{\PYZlt{}}\PY{n}{label} \PY{k}{for}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{PRO\PYZus{}QUANTITE\PYZus{}217751}\PY{l+s}{\PYZdq{}} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{isNotNull isInt invisible}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}\PY{n}{Quantit}\PY{err}{é}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{label}\PY{o}{\PYZgt{}}
                                                       \PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n}{value}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{1}\PY{l+s}{\PYZdq{}} \PY{n}{size}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{2}\PY{l+s}{\PYZdq{}} \PY{n}{maxlength}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{2}\PY{l+s}{\PYZdq{}} \PY{n}{name}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{PRO\PYZus{}QUANTITE}\PY{l+s}{\PYZdq{}} \PY{n+nb}{id}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{PRO\PYZus{}QUANTITE\PYZus{}217751}\PY{l+s}{\PYZdq{}} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{text}\PY{l+s}{\PYZdq{}} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{alignright}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{td}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{a} \PY{n}{href}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{javascript:addP(}\PY{l+s}{\PYZsq{}}\PY{l+s}{PRO\PYZus{}QUANTITE\PYZus{}217751}\PY{l+s}{\PYZsq{}}\PY{l+s}{, 1)}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{n}{img} \PY{n}{src}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{http://www.livraison.simplymarket.fr/images\PYZus{}27/pictoPlus3.png}\PY{l+s}{\PYZdq{}} \PY{n}{alt}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Plus}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{a}\PY{o}{\PYZgt{}}
                                                   \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tr}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{table}\PY{o}{\PYZgt{}}
                                       \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                       \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{panier aligncenter}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n}{name}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{idP}\PY{l+s}{\PYZdq{}} \PY{n}{value}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{217751}\PY{l+s}{\PYZdq{}} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{hidden}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n}{name}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{idR}\PY{l+s}{\PYZdq{}} \PY{n}{value}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{377}\PY{l+s}{\PYZdq{}} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{hidden}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n}{name}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{idS}\PY{l+s}{\PYZdq{}} \PY{n}{value}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{1770}\PY{l+s}{\PYZdq{}} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{hidden}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{hidden}\PY{l+s}{\PYZdq{}} \PY{n}{name}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{reloadProduit}\PY{l+s}{\PYZdq{}} \PY{n}{value}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{1}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n}{name}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{addP}\PY{l+s}{\PYZdq{}} \PY{n}{value}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{217751}\PY{l+s}{\PYZdq{}} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{hidden}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                                                                                               \PY{o}{\PYZlt{}}\PY{n+nb}{input} \PY{n+nb}{type}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{image}\PY{l+s}{\PYZdq{}} \PY{n}{src}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{http://www.livraison.simplymarket.fr/images\PYZus{}27/caddie.png}\PY{l+s}{\PYZdq{}} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{image}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                                                                                   \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                       \PY{o}{\PYZlt{}}\PY{n}{td} \PY{n}{class}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{liste aligncenter}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                                                               \PY{o}{\PYZlt{}}\PY{n}{a} \PY{n}{href}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsh{}}\PY{l+s}{\PYZdq{}} \PY{n}{onclick}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{javascript:window.parent.YAHOO.ownFrame.close();window.parent.YAHOO.ownFrameAlerte.showSmooth(}\PY{l+s}{\PYZsq{}}\PY{l+s}{Vous devez vous identifier pour accéder à cette fonctionnalité}\PY{l+s}{\PYZsq{}}\PY{l+s}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{alert}\PY{l+s}{\PYZsq{}}\PY{l+s}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}\PY{l+s}{);return false;}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{n}{img} \PY{n}{src}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{http://www.livraison.simplymarket.fr/images\PYZus{}27/ajoutListeBig.png}\PY{l+s}{\PYZdq{}} \PY{n}{title}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Ajouter à la liste}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{a}\PY{o}{\PYZgt{}}
                                                                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tr}\PY{o}{\PYZgt{}}
                               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{table}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
           ...
           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{form}\PY{o}{\PYZgt{}}
               ...
               \PY{o}{\PYZlt{}}\PY{n}{div} \PY{n+nb}{id}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{logoProduit}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
               \PY{o}{\PYZlt{}}\PY{n}{table} \PY{n}{width}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{100}\PY{l+s}{\PYZpc{}}\PY{l+s}{\PYZdq{}} \PY{n}{cellspacing}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{0}\PY{l+s}{\PYZdq{}} \PY{n}{cellpadding}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{0}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                   \PY{o}{\PYZlt{}}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{n}{tr}\PY{o}{\PYZgt{}}
                                                                                                                   \PY{o}{\PYZlt{}}\PY{n}{td}\PY{o}{\PYZgt{}}
                                  \PY{o}{\PYZlt{}}\PY{n}{img} \PY{n}{src}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{http://media.simplymarket.fr/LOGOTYPE/d7/LOG\PYZus{}LOGO\PYZus{}113\PYZus{}1387182117.gif}\PY{l+s}{\PYZdq{}} \PY{n}{onmouseover}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{return overlib(}\PY{l+s}{\PYZsq{}}\PY{l+s}{				                				                \PYZlt{}div align=}\PY{l+s}{\PYZbs{}}\PY{l+s}{\PYZam{}quot;center}\PY{l+s}{\PYZbs{}}\PY{l+s}{\PYZam{}quot;\PYZgt{}Produits frais.\PYZlt{}br /\PYZgt{}A conserver entre 0\PYZam{}amp;deg; et 4\PYZam{}amp;deg;.\PYZlt{}br /\PYZgt{}\PYZlt{}/div\PYZgt{}\PYZlt{}div align=}\PY{l+s}{\PYZbs{}}\PY{l+s}{\PYZam{}quot;center}\PY{l+s}{\PYZbs{}}\PY{l+s}{\PYZam{}quot;\PYZgt{}								\PYZlt{}/div\PYZgt{}               					               					}\PY{l+s}{\PYZsq{}}\PY{l+s}{, CENTER, VAUTO);}\PY{l+s}{\PYZdq{}} \PY{n}{onmouseout}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{return nd();}\PY{l+s}{\PYZdq{}}\PY{o}{\PYZgt{}}
                           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{td}\PY{o}{\PYZgt{}}
                                               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tr}\PY{o}{\PYZgt{}}
               \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{tbody}\PY{o}{\PYZgt{}}\PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{table}\PY{o}{\PYZgt{}}
           \PY{o}{\PYZlt{}}\PY{o}{/}\PY{n}{div}\PY{o}{\PYZgt{}}
...
build a clean dataset available for analysis.
    ...
    \subsection{Distance between products}
